...
Hello, thank you for using Git Repo URL! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-git-repo-url/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-git-repo-url/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-git-repo-url/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - Git Repo URL version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-git-repo-url/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-git-repo-url/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Git Repo URL:
...
<div align="center">
  Thank you for using Git Repo URL!
  <br>
